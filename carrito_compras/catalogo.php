...
//comprobamos con isset) y los asignamos a $prova. Si no existen valores, ponemos a false el
//valor de $prova
if(isset($_SESSION['prova']))
$prova=$_SESSION['prova'];else $prova=false;
...
<body>
<table width="500" align="center" cellpadding="0" cellspacing="0" style="border: 1px solid #000000;">
  ...
  <?php
  //mostramos todos nuestros artículos, viendo si han sido agregados o no a nuestro prova de compra
  ...
  <tr valign="middle" class="catalogo"> 
    ...
    <td align="center"><?php
	if(!$prova || !isset($prova[md5($row['id'])]['identificador']) || $prova[md5($row['id'])]['identificador']!=md5($row['id'])){
	...
	//en caso contrario mostramos la otra imagen linkeada., a la página que sirve para borrar el artículo del prova.
